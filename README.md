# MODEL1310110002: MODEL1310110002
...
`pip install git+https://github.com/biomodels/MODEL1310110002.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL1310110002.git@20140916`

## Usage

Importing the model package.

`import MODEL1310110002 as model`
...
Thiele2013 - Spleen cells in white pulp

The model of spleen cells in white pulp metabolism is derived from the
...
and identified by:
[MODEL1310110002](http://identifiers.org/biomodels.db/MODEL1310110002) .
